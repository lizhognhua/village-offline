...
export async function GET() {
  ...
  try {
    ...
    const [
      ...
      prisma.householdRecord.count({ where: { type: "visit" } }),
      prisma.householdRecord.count({ where: { type: "visit", recordDate: { gte: thisMonth } } }),
      prisma.householdRecord.count({ where: { type: "condolence" } }),
      prisma.householdRecord.count({ where: { type: "condolence", recordDate: { gte: thisMonth } } }),
