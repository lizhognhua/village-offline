...
import { LayoutDashboard, FolderArchive, Map, Footprints, BookOpen, Wheat, Kanban, ChevronLeft, ChevronRight, Flag, MapPin, ImageIcon, BarChart3, Settings } from "lucide-react";
